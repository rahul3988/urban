...
interface RecentActivity {
  id: string;
  type: 'user_registration' | 'vendor_registration' | 'order_placed' | 'payment_received';
  description: string;
  timestamp: string;
  user: string;
}
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900">{stats.totalVendors.toLocaleString()}</p>
              </div>
            </div>
          </div>
